...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    desc:
      "Inventory and pathway done as one piece of work. Where the footprint sits today. Where business-as-usual takes it tomorrow. And what it takes to achieve net zero.",
    data:
